          ...
          <form role="form" action="" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="product_name" name="product_name" placeholder="Enter item name" autocomplete="off" value="<?php echo $this->input->post('product_name') ?>" />
                </div>
                ...
                <div class="form-group" style="display:none;">
                  ...
                  <select class="form-control select_group" id="store" name="store[]" multiple="multiple">
                    <?php foreach ($stores as $k => $v): ?>
                      <option <?php if($v['id'] == 1) { ?> selected <?php } ?> value="<?php echo $v['id'] ?>"><?php echo $v['name'] ?></option>
                    <?php endforeach ?>
                  </select>
                </div>
