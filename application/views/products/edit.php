<style>
    .file-input.file-input-new > .btn.btn-secondary { display:none !important; }
</style>
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <?php if ($product_data['image'] == '<p>You did not select a file to upload.</p>') { ?>
                    <img src="<?php echo base_url('assets/images/product_image/no-image-icon.png'); ?>" width="150" height="150" class="img-circle">
                  <?php } else { ?>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="product_name" name="product_name" placeholder="Enter item name" autocomplete="off" value="<?php echo !empty($this->input->post('product_name')) ?:$product_data['name'] ?>" />
                </div>
